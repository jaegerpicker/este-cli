 ...
 * @param {String?} stringValue, when provided, its used instead of objectExpression
 * @returns {Property} newly created element
 */
ObjectExpression.prototype.addProperty = function(propertyName, isShort, stringValue) {
  var content = stringValue ? b.literal(stringValue) : b.objectExpression([]);
